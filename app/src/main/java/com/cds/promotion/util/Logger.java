...
public class Logger {
    ...
    static {
        ...
        if (isSDCardOK()) {
            defaultDir = Environment.getExternalStorageDirectory() + "/wecare/promotion/logger/";
        } else {
            defaultDir = App.getInstance().getCacheDir().getAbsolutePath() + "/wecare/promotion/logger";
        }
    }
